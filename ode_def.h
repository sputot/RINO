      ...
      void operator()(vector<C> &yp, vector<C> param_inputs, vector<C> y) {
	    ...
	    static const double p_sp = -0.1; //1.0*M_PI/180.0;  // angular speed of 1 degree / sec
	      ...
	      static const double Ki_VZ = 300.0;
              ...
              static const double Kp_rr = 1000.0;
              static const double Kp_pr = 1000.0;
              static const double Kp_yr = 2000.0;
              
              static const double Ki_rr = 400.0;
              static const double Ki_pr = 400.0;
              static const double Ki_yr = 1000.0;
	      ...
	      */
	      ...
	      // PID commands
              ...
              auto cmd_y = y[8]*Ki_yr + err_r*Kp_yr + Kd_yr*yp[5]; // cmd_psi
          ...
          else if(syschoice == 44) // HSCC 2019 paper crazyflie example+effets aerodynamiques; PID of Arthur; with aerodynamical effects
          {
	    static const double p_sp = -0.1; //1.0*M_PI/180.0;  // angular speed of 1 degree / sec
              static const double q_sp = 0.1;
              static const double r_sp = 0.1;
