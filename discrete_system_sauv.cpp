...
void print_outer_range(vector<interval> &z_o, vector<interval> &range) {
    for (int i=0; i < sysdim ; i++) {
        ...
        cout << " eta["<<i<<"]=" << (range[i].sup() - range[i].inf())/ (z_o[i].sup() - z_o[i].inf()) <<" "; // precision metric with respect to estimated range
    }
    cout << endl;
}
    ...
    for (int step = 1; step <= nb_steps ; step++)
    {
        ...
        if (order == 2)
        {
          ...
          //  zf0_o = FFunc(dfdx0_o,x0_o);  // can't use it here because of preconditioning
            ...
            F<interval> tempf = A_o[varx][varx]*x0ff_o[varx] + A_o[varx][vary]*x0ff_o[vary];
         ...
         //   cout << "zf0_i=" << zf0_i;
            ...
            F<F<AAF>> tempaff = A_o[varx][varx]*xff_o[varx] + A_o[varx][vary]*xff_o[vary];
        ...
        if (sysdim >= 2) {
          ...
          //  cout << "Jacf_o=" << Jacf_o;
            multMiMi(CJacf_o,C_o,Jacf_o);
          //  cout << "CJacf_o=" << CJacf_o;
          //  cout << "Jacf_i=" << Jacf_i;
            multMiMi(CJacf_i,C_i,Jacf_i);
         //   cout << "CJacf_i=" << CJacf_i;
...
void function_range(char * config_filename) {
